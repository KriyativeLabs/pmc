...
SELECT audit.audit_table('areas');
SELECT audit.audit_table('companies');
SELECT audit.audit_table('company_statistics');
SELECT audit.audit_table('connections');
SELECT audit.audit_table('customers');
SELECT audit.audit_table('notifications');
SELECT audit.audit_table('payments');
SELECT audit.audit_table('plans');
SELECT audit.audit_table('user_area_mapping');
